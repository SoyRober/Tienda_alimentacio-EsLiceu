<?php   
    ...
    $query="INSERT INTO Client (dniClient, Pais, Nom, CP, Telefon, Provincia, Poblacio, Adreca, fkidTargeta, Email) 
            VALUES (\"$_POST[dniClient]\",\"$_POST[Pais]\",\"$_POST[Nom]\",\"$_POST[CP]\",\"$_POST[Telefon]\",\"$_POST[Provincia]\",\"$_POST[Poblacio]\",\"$_POST[Adreca]\",\"$_POST[fkidTargeta]\",\"$_POST[Email]\");";   
    echo $query;
